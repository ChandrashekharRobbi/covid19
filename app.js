...
xmlhttp.onreadystatechange = function () {
    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        document.getElementById('active-values').innerHTML = number_formatting.format(value_confirmed);
        const values_newConfirmed = data.Global.NewConfirmed;
        document.getElementById('new-values').innerHTML = '+';

        document.getElementById('new1-values').innerHTML = number_formatting.format(values_newConfirmed);
        ...
        document.getElementById('Deaths-values').innerHTML = number_formatting.format(value_totaldeaths);
        const values_newDeaths = data.Global.NewDeaths;
        document.getElementById('new-death-plus-values').innerHTML = '+';

        document.getElementById('new-deaths-values').innerHTML = number_formatting.format(values_newDeaths);
...
myForm.addEventListener('submit', function (e) {
    ...
    xmlhttp.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById('active-values').innerHTML = number_formatting.format(value_active);
            ...
            document.getElementById('Confirmed-values').innerHTML = number_formatting.format(value_confirm);
            ...
            document.getElementById('Deaths-values').innerHTML = number_formatting.format(value_death);
